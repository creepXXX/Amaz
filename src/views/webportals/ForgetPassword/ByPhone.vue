    ...
    <div class="ByPhone">
        <div class="title">
            <p class="title-left">
                ...
                <span class="immigration" @click="switchover(2)">找回密码</span>
                <span class="iconfont next">&#xe60b;</span>
                <span>通过手机</span>
            </p>
            <p class="title-right">
                <span class="iconfont immigration" @click="switchover(2)">&#xe60a;</span>
                <span class="iconfont immigration">&#xe66d;</span>
            </p>
        </div>
        <div class="content">
            <el-row>
                <el-form>
                    ...
                    <div class="content-input">
                        <p><span>*</span>手机号:</p><el-input class="input" v-model="input" placeholder="手机号码" clearable></el-input>
                    </div>
                    <div class="content-input">
                        <p><span>*</span>验证码:</p><el-input class="input" v-model="input" placeholder="短信验证码" clearable></el-input>
                        <span class="code" @click="sendCode" :class="{'codeColor':codeColor}" >{{codeMsg==''?'发送验证码':codeMsg}}</span>
                    </div>
                    <div class="content-input">
                        <p><span>*</span>新登录密码:</p><el-input class="input" v-model="input" placeholder="设置6至20位登录密码"></el-input>
                    </div>
                    <div class="content-input">
